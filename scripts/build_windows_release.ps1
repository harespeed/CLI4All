...
Copy-Item (Join-Path $repoRoot "data\commands.source.json") (Join-Path $stageDir "data\commands.source.json") -Force
Copy-Item (Join-Path $repoRoot "data\commands.c4idx") (Join-Path $stageDir "data\commands.c4idx") -Force
Copy-Item (Join-Path $repoRoot "data\commands.c4dat") (Join-Path $stageDir "data\commands.c4dat") -Force
