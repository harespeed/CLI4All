...
Copy-Item (Join-Path $dataSource "commands.source.json") (Join-Path $dataDir "commands.source.json") -Force
Copy-Item (Join-Path $dataSource "commands.c4idx") (Join-Path $dataDir "commands.c4idx") -Force
Copy-Item (Join-Path $dataSource "commands.c4dat") (Join-Path $dataDir "commands.c4dat") -Force
...
Write-Output "Installed command index and data files to $dataDir"
